...
# Short description:  
Helpful application for tracking your current, desired and already read books.

## Description
This is a more finalized MyReads Project built from Udacity's starter template provided in React Nanodegree Program >> React Fundamentals [ Project 1 ]
...
## git
https://github.com/philsaltsman/reactnd-project-myreads

## Enjoy
Have fun using your new MyReads application!
